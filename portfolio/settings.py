...
# TEMPLATES_DIRS = os.path.join(BASE_DIR, "templates/sadat_templates")
# TEMPLATES_DIR = os.path.join(BASE_DIR, "templates")
STATIC_DIR = os.path.join(BASE_DIR, "static")
MEDIA_DIR = os.path.join(BASE_DIR, "midea")
...
SECRET_KEY = '70-q=3ofcg+8ihz3ght+zzz_4)itrggy4lm84^qs$d(sg0mow&'
...
TEMPLATES = [
    {
        ...
        # 'DIRS': [os.path.join(BASE_DIR, "templates/sadat_templates")], #- check it works or not
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
